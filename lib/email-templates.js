  ...
  <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;max-width:560px;">
    ...
    <tr><td align="center" style="padding:26px 12px 0;">
      <p style="margin:0 0 6px;${f(400, 12, 1.6)}color:${C.faint};">
        ...
        &nbsp;&middot;&nbsp; From goal to merged PR, fully in control
      </p>
      <p style="margin:0;${f(400, 12, 1.6, "Georgia,'Times New Roman',serif")}font-style:italic;color:${C.faint};">
...
function customerEmail({ name }) {
  ...
  const steps = [
    ...
    ["You see Syrus on your roadmap", "Goals become tracked epics &amp; tickets, AI writes the code, and your team approves every merge — live, end to end."],
  ];
...
3. You see Syrus on your roadmap: goals become tracked epics & tickets, AI writes the code, and your team approves every merge.
